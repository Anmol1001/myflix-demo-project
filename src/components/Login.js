...
const Login = () => {
  ...
  const login = async () => {
    setLoading(true)
    //here we compare password, mobile. and it is right then we give true value to login.
    try {
  ...
  return (
    ...
    <div class="p-2 w-full md:w-1/3">
        ...
        <div class="p-2 w-full">
          <button 
          onClick={login}
          class="flex mx-auto text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-700 rounded text-lg">{loading?<TailSpin height={25} color="white" />:'Login'}</button>
        </div>
        <div>
